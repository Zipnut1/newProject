...
//     const removedNum =array[array.length-1];
//     tempArray.pop();
...
//         if(i%2===0){
//             reversedArray[i] *=2
//             console.log("Number in array"+reversedArray[i]);
...
//     console.log(sum+removedNum)%10===0;
//     return (sum+removedNum)% 10 ===0;
// }
function validateCred(array){
    ...
    //loops through card number from right to left 
